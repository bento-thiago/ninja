...
class PastaIss(AbstractPastaContabil, PastaImpostoComRetencao):
    tipo_documento_retencao: DocumentoTipo = DocumentoTipo.GUIA_RETENCAO_ISS
    imposto: str = ItemDocumentoTipoImposto.ISS
    ...
    def get_definicoes_lancamentos_escrituracao_futura_parte_realizada(self, configuracoes: dict) -> List[DefinicaoLancamento]:
        ...
        saida.append(DefinicaoLancamento(
            ...
            natureza='C',
            conta='1.1.1.01',
            historico='Pagamento de guia de ISS retido',
            formula='valor_calculado',
            formula_data='competencia_final',
            situacao=SituacaoDiario.PREVISTO,
            definicao='iss__retido.esc_futura.conclusao'
