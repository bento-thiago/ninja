...
class PastaIcms(AbstractPastaContabil, PastaImpostoComRetencao):
    tipo_documento_retencao: DocumentoTipo = DocumentoTipo.GUIA_RETENCAO_ICMS
    imposto: str = ItemDocumentoTipoImposto.ICMS
    ...
    def get_definicoes_lancamentos_escrituracao_futura_parte_realizada(self, configuracoes: dict) -> List[DefinicaoLancamento]:
        ...
        saida.append(DefinicaoLancamento(
            ...
            natureza='C',
            conta='1.1.1.01',
            historico='Pagamento de guia de ICMS retido',
            formula='valor_calculado',
            formula_data='competencia_final',
            situacao=SituacaoDiario.PREVISTO,
            definicao='icms__retido.esc_futura.conclusao'
