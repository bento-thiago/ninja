...
class PastaCofins(AbstractPastaContabil, PastaImpostoComRetencao):
    tipo_documento_retencao: DocumentoTipo = DocumentoTipo.GUIA_RETENCAO_COFINS
    imposto: str = ItemDocumentoTipoImposto.COFINS
    ...
    def get_definicoes_lancamentos_escrituracao_futura_parte_realizada(self, configuracoes: dict) -> List[DefinicaoLancamento]:
        ...
        saida.append(DefinicaoLancamento(
            ...
            natureza='C',
            conta='1.1.1.01',
            historico='Pagamento de guia de COFINS retido',
            formula='valor_calculado',
            formula_data='competencia_final',
            situacao=SituacaoDiario.PREVISTO,
            definicao='cofins__retido.esc_futura.conclusao'
