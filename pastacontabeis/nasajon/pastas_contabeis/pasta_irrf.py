...
class PastaIrrf(AbstractPastaContabil, PastaImpostoComRetencao):
    tipo_documento_retencao: DocumentoTipo = DocumentoTipo.GUIA_RETENCAO_IRRF
    imposto: str = ItemDocumentoTipoImposto.IRRF
    ...
    def get_definicoes_lancamentos_escrituracao_futura_parte_realizada(self, configuracoes: dict) -> List[DefinicaoLancamento]:
        ...
        saida.append(DefinicaoLancamento(
            ...
            natureza='C',
            conta='1.1.1.01',
            historico='Pagamento de guia de IRRF retido',
            formula='valor_calculado',
            formula_data='competencia_final',
            situacao=SituacaoDiario.PREVISTO,
            definicao='irrf__retido.esc_futura.conclusao'
